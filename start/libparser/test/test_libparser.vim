...
def Test_CT_ParseManyInfiniteLoop()
  var ctx = { text: "xyxyxyz", index: 0 }
...
def Test_CT_ParseExpectedColon001()
...
def Test_CT_ParseExpectedColon002()
  var ctx = { text: "Author=:", index: 0 }
...
def Test_CT_ParseExpectedColon003()
  var ctx = { text: "X=:", index: 0 }
...
def Test_CT_ManyWithOptionalInfiniteLoop()
  var ctx = { text: "\n", index: 0 }
