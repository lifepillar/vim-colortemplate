...
syn match colortemplateInfoDelta /\d\d\.\d\+\|[3456789]\.\d\+\|2\.[456789]\d*/ contained
...
syn region colortemplateInfoCRT matchgroup=colortemplateInfoTitle start=/^{{{ Critical.*$/ end=/^}}} Critical.*$/ contains=colortemplateInfoTitle keepend
